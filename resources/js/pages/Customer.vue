<template>
    <div>
        <el-page-header @back="$emit('back')" content="CUSTOMERS"> </el-page-header>
        <el-divider></el-divider>
        <el-form :inline="true" style="text-align:right" @submit.native.prevent="() => { return }">
            <el-form-item>
                <el-button @click="openForm({role: 0, password: ''})" type="primary"><i class="el-icon-plus"></i> ADD NEW CUSTOMER</el-button>
            </el-form-item>
        ...
        @sort-change="sortChange">
            ...
            <el-table-column prop="address" label="Address" sortable="custom" show-overflow-tooltip></el-table-column>
            <el-table-column prop="contact_person" label="Contact Person" sortable="custom" show-overflow-tooltip></el-table-column>
        ...
        <el-dialog :visible.sync="showForm" :title="!!formModel.id ? 'EDIT CUSTOMER' : 'ADD NEW CUSTOMER'" width="500px" v-loading="loading" :close-on-click-modal="false">
            ...
            <el-form label-width="120px">
                ...
                <el-form-item label="Contact Person" :class="formErrors.contact_person ? 'is-error' : ''">
