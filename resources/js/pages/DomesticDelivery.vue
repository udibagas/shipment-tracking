<template>
    <div>
        ...
        <el-form :inline="true" style="text-align:right" @submit.native.prevent="() => { return }">
            <el-form-item>
                <el-button @click="openForm({role: 0, password: ''})" type="primary"><i class="el-icon-plus"></i> ADD NEW DOMESTIC DELIVERY</el-button>
            </el-form-item>
        ...
        <el-dialog :visible.sync="showForm" :title="!!formModel.id ? 'EDIT DOMESTIC DELIVERY' : 'ADD NEW DOMESTIC DELIVERY'" width="550px" v-loading="loading" :close-on-click-modal="false">
