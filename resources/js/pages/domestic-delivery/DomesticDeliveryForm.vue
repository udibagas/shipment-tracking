  ...
  computed: {
    ...
    totalVolume() {
      return this.formModel.items.reduce((prev, curr) => {
        return (
          prev +
          (curr.dimension_p * curr.dimension_l * curr.dimension_t) / 1000000
        );
      }, 0);
    },
    totalVolumePacking() {
    ...
    totalVolumeWeight() {
      return this.formModel.items.reduce((prev, curr) => {
        return (
          prev + (curr.dimension_p * curr.dimension_l * curr.dimension_t) / 4000
        );
      }, 0);
    },
    totalInvoiceWeight() {
      let total = this.formModel.items.reduce((prev, curr) => {
        let invoiceWeight =
          (curr.dimension_p * curr.dimension_l * curr.dimension_t) / 4000;
