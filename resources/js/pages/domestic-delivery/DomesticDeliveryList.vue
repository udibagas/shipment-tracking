<template>
    <div>
                ...
                <template slot-scope="scope">
                    <el-dropdown>
                        ...
                        <el-dropdown-menu slot="dropdown">
                            ...
                            <el-dropdown-item icon="el-icon-warning-outline" v-if="scope.row.delivery_status_id < 4" @click.native.prevent="openStatusForm(scope.row)">Update Status</el-dropdown-item>
                            <el-dropdown-item icon="el-icon-edit-outline" v-if="scope.row.delivery_status_id < 4" divided @click.native.prevent="openForm(scope.row)">Edit</el-dropdown-item>
        ...
        <DomesticDeliveryForm :delivery="formModel" :show="showForm" @close="showForm = false" @refresh="requestData" />
