<template>
    <el-dialog fullscreen :visible.sync="visible" title="KIRIM REPORT" :show-close="false" v-loading="loading">
        <el-form label-position="left" label-width="150px">
            <el-row :gutter="30">
                <el-col :span="12">
                    <el-form-item label="Customer" :class="formErrors.customer_id ? 'is-error' : ''">
                        <el-select @change="getItems" filterable default-first-option clearable v-model="formModel.customer_id" placeholder="Customer" style="width:100%">
