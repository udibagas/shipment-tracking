  ...
  >
    <el-form label-width="150px" label-position="left">
      ...
      >
        ...
        >{{formErrors.delivery_date[0]}}</div>
      </el-form-item>
      ...
      >
        ...
        >{{formErrors.vehicle_number[0]}}</div>
      </el-form-item>
      ...
      >
        ...
        >{{formErrors.driver_phone[0]}}</div>
      </el-form-item>

      <!-- status = Delivered -->
      <el-form-item
        v-show="formModel.status == 3"
      ...
      >
        ...
        >{{formErrors.delivered_date[0]}}</div>
      </el-form-item>

      <!-- STT diterima -->
      <el-form-item
        v-show="formModel.status == 4"
      ...
      >
        ...
        >{{formErrors.stt_received_date[0]}}</div>
      </el-form-item>
      ...
      >
        <el-input placeholder="Penerima" v-model="formModel.receiver"></el-input>
...
export default {
  ...
  methods: {
    submit() {
      this.$confirm("Anda yakin?", "Warning", { type: "warning" })
        .then(() => {
          this.formModel.delivery_id = this.data.id;
          axios
            .post("deliveryProgress", this.formModel)
            .then(r => {
              this.$message({
