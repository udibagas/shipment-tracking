	...
	<div>
		...
		>
			...
			<el-table-column
				...
				header-align="center"
			>
				<template slot-scope="scope"> {{ scope.row.minimum }} KG </template>
			</el-table-column>
			<el-table-column
				prop="ppn"
				label="PPN"
		...
		<el-dialog
			...
			:title="!!formModel.id ? 'EDIT TARIF REGULER' : 'TAMBAH TARIF REGULER'"
			width="500px"
			v-loading="loading"
		...
		>
			...
			<el-form label-width="150px" label-position="left">
				...
				<el-form-item
					label="Minimum Charge (KG)"
					:class="formErrors.minimum ? 'is-error' : ''"
				>
					<el-input
						type="number"
						placeholder="Minimum Charge (KG)"
						v-model="formModel.minimum"
					></el-input>
					<div class="el-form-item__error" v-if="formErrors.minimum">
						{{ formErrors.minimum[0] }}
					</div>
				</el-form-item>
...
export default {
	...
	computed: {
		...
		...mapState(["customerList", "cityList", "vehicleTypeList"])
	}
};
</script>
