<template>
    ...
    :before-close="closeForm">
        ...
        <el-table :data="formModel.items">
            ...
            <el-table-column v-if="formModel.service_type == 'REGULER'" label="Koli" width="115">
                <template slot-scope="scope">
                    <el-input type="number" v-model="scope.row.total_coli" size="small"></el-input>
                </template>
            </el-table-column>
            <el-table-column v-if="formModel.service_type == 'REGULER'" label="KG/M3" width="115">
                <template slot-scope="scope">
                    <el-input v-model="scope.row.quantity" size="small"></el-input>
                </template>
            </el-table-column>
            <el-table-column v-if="formModel.service_type == 'REGULER'" label="" prop="unit" width="40"></el-table-column>
            <el-table-column label="Tarif" width="110">
                <template slot-scope="scope">
                ...
                r.data.forEach(data => {
                    ...
                    if (d.packing_cost > 0) {
                        ...
                        d.description = {
                            ...
                            vehicle_type: d.vehicle_type ? d.vehicle_type.name : '',
                            spb_number: d.spb_number,
                            total_coli: d.quantity.items.filter(i => i.packing).length
                        }
